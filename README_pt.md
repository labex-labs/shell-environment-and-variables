...
<p align="center">
  <a href="https://labex.io/pt/courses/shell-environment-and-variables">
    <img src="https://course-cover.labex.io/shell-environment-and-variables.png?lang=pt" alt="Ambiente e Variáveis do Shell">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/shell-environment-and-variables)

## Exercícios

|   Índice | Nome                                   | Dificuldade   | Prática                                                                                                                                                |
|----------|----------------------------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Explicação sobre Variáveis de Ambiente | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-environment-variables-explained-636068?course=shell-environment-and-variables'>Iniciar Lab</a> |
|        2 | A variável PATH                        | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-the-path-variable-636070?course=shell-environment-and-variables'>Iniciar Lab</a>               |
|        3 | Criando Variáveis Personalizadas       | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-creating-custom-variables-636067?course=shell-environment-and-variables'>Iniciar Lab</a>       |
|        4 | Configuração Persistente               | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-persistent-configuration-636069?course=shell-environment-and-variables'>Iniciar Lab</a>        |
|        5 | Substituição de Comandos               | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-command-substitution-636066?course=shell-environment-and-variables'>Iniciar Lab</a>            |
|        6 | Script de Configuração do Ambiente     | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-environment-setup-script-636319?course=shell-environment-and-variables'>Iniciar Desafio</a>    |
